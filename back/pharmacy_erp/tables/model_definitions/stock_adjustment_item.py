...
class StockAdjustmentItem(models.Model):
    ...
    # NEW: Cost tracking for adjustments
    cost_layers_affected = models.JSONField(
        default=list,
        help_text="Cost layers affected by this adjustment"
    )
    total_cost_adjustment = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        default=0,
        help_text="Total value of cost adjustment"
    )
