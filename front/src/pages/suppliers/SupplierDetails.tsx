...
//       try {
//         const data = await fetchSupplierLogs(supplierId);
//         setLogs(data);
//       } catch (error) {
...
//     } catch (error) {
//       showError("Failed to submit supplier.");
//     }
//   };
...
//           className="mt-4 text-xs font-bold uppercase tracking-[0.2em] text-emerald-600"
//         >
//           Back to registry
//         </button>
//       </div>
...
//           </button>
//           <div>
//             <h1 className="flex items-center gap-3 text-2xl font-black tracking-tight text-slate-900 dark:text-white md:text-3xl">
//               {supplier.name}
//               <span
...
//               className="rounded-xl bg-emerald-600 px-5 py-2.5 text-xs font-black uppercase tracking-[0.2em] text-white shadow-xl"
//             >
//               Submit
//             </button>
//           )}
...
//                 setIsEditing(true);
//               }}
//               className="rounded-xl bg-slate-900 px-5 py-2.5 text-xs font-black uppercase tracking-[0.2em] text-white shadow-xl dark:bg-white dark:text-slate-900"
//             >
//               Edit
//             </button>
//           )}
...
//                   setIsEditing(false);
//                 }}
//                 className="rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-black uppercase tracking-[0.2em] text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
//               >
//                 Discard
//               </button>
//               <button
//                 onClick={handleSave}
//                 disabled={isSaving}
//                 className="rounded-xl bg-emerald-600 px-5 py-2.5 text-xs font-black uppercase tracking-[0.2em] text-white shadow-xl disabled:cursor-not-allowed disabled:opacity-60"
//               >
...
//                   disabled={!isEditing}
//                   className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold outline-none transition-all focus:border-emerald-500 disabled:cursor-default disabled:opacity-80 dark:border-slate-800 dark:bg-slate-800 dark:text-white"
//                 />
//               </label>
//               <label className="space-y-2">
//                 <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">
...
//                 disabled={!isEditing}
//                 rows={4}
//                 className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium outline-none transition-all focus:border-emerald-500 disabled:cursor-default disabled:opacity-80 dark:border-slate-800 dark:bg-slate-800 dark:text-white"
//               />
//             </label>
//           </section>
...
//                   <div
//                     key={log.log_id}
//                     className="rounded-2xl border border-slate-100 bg-slate-50/70 p-4 dark:border-slate-800 dark:bg-slate-800/30"
//                   >
//                     <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
//                       <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-800 dark:text-slate-100">
//                         {log.action}
//                       </span>
...
//             <h3 className="mb-4 text-sm font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white">
//               Actions
//             </h3>
//             <div className="space-y-3">
//               <button
//                 onClick={() => handleToggleActive(!supplier.is_active)}
//                 className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.2em] text-slate-700 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200"
//               >
...
//                 className="w-full rounded-xl border border-rose-200 bg-rose-50 px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.2em] text-rose-700 disabled:cursor-not-allowed disabled:opacity-50 dark:border-rose-900/40 dark:bg-rose-950/40 dark:text-rose-300"
//               >
//                 Cancel Supplier
//               </button>
//             </div>
